...
/**
 * Extension point to create custom rule repository for Swagger.
 */
@ExtensionPoint
@BatchSide
public abstract class CustomSwaggerRulesDefinition implements RulesDefinition {
	 ...
	 * This method should be overridden if check metadata are provided via another
	 * format, e.g: XMl, Swagger.
	 */
	@Override
